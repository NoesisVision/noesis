...
| `change.ts`                                                                               | `change.md`                                  | `changes/<change>/change.json` — the unit of work imports and design docs belong to            |
...
| `design-doc.ts`, `design-doc-ref.ts`                                                      | `design-doc.md`                              | `changes/<change>/design-docs/` — the normalised design-doc model (decision 50) and its refs   |
