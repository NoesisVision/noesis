# Architecture Decision Log — ARCHIVE (historical, do not use for current work)

> **Agents: stop reading.** This file is the append-only history of decisions
> 1–76, frozen on 2026-09-17. Most of it describes code, hosting, auth and
> tooling that no longer exist, and entries contradict each other because later
> ones superseded earlier ones. The current decisions are in
> [`docs/decisions.md`](../decisions.md) (D1–D10). The map below and the
> **Now:** line under each heading say where an entry's live content went. Open this file only when a person
> explicitly asks for the history behind a decision.

Decisions made while shaping this monorepo, in chronological order. Format: context → decision → rationale/consequences. Numbers cited as "decision N" inside this file refer to entries of this file.

_Frozen: 2026-09-17. Last entry: 76 (2026-09-13)._

---

## Map to the current decisions

Where each entry's live content went in [`docs/decisions.md`](../decisions.md).
"retired" means nothing of the entry binds current work.
...
> **Now:** live content consolidated into D7 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** retired — nothing in this entry binds current work; see D1–D10 in [`docs/decisions.md`](../decisions.md).
...
> **Now:** live content consolidated into D4 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D6 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D8 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D3 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D9 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D7, D8 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D3, D5 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D5 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D5, D7 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D1, D9 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D1 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D1, D2, D3, D4, D6, D9 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D4, D6 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D2, D5 of [`docs/decisions.md`](../decisions.md); anything here that they do not repeat is superseded.
...
> **Now:** live content consolidated into D10 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
...
> **Now:** live content consolidated into D2 of [`docs/decisions.md`](../decisions.md); anything here that it does not repeat is superseded.
