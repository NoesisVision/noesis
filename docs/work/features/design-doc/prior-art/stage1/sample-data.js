...
((global) => {
  const doc = {
    ...
    suggestions: [
      ...
      },
      {
        ...
        agent: true,
        time: '3 hours ago',
        note: 'Same change the pending proposal argues for; accepting it here keeps the rule and the proposal aligned.',
      },
      {
        id: 'sg-3',
  ...
  uc.push({
    ...
    comments: [
      ...
      },
      {
        ...
        role: 'QA',
        time: 'yesterday',
        body: '@agent add an acceptance scenario for two patients racing for the same slot while one holds it.',
        mentions: ['agent'],
        resolved: false,
        replies: [
          {
            ...
            role: 'Agent',
            time: 'yesterday',
            body: 'Added to the pending proposal as "Concurrent booking attempts on one slot". Review it with the rest of the proposal.',
            agent: true,
          },
        ],
      },
    ...
    comments: [
      {
        ...
        agent: true,
        time: '3 hours ago',
        body: 'The pending proposal challenges the 24-hour refund rule and proposes 12 hours for same-week bookings. Reason in the proposal impact.',
        resolved: false,
        replies: [],
      },
    ],
  ...
  const proposal = {
    ...
    trigger:
      'Comment from Priya Nair on Book appointment, plus the no-show reduction brief',
    summary:
      ...
      specOnly: [
        {
          ...
          detail: "added in response to Priya Nair's comment",
        },
        {
          id: 'uc-hold-slot',
          kind: 'Description',
  ...
  const mentionable = [
    ...
    { id: 'sam', label: 'Sam Whitfield', hint: 'Developer' },
    {
      id: 'agent',
      label: 'agent',
      hint: 'Design agent — mention to request a proposal',
    },
  ];
