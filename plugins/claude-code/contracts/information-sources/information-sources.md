<!-- Copied from packages/shared-contracts/src/information-sources/information-sources.md by @noesis-vision/noesis 0.1.0-beta.4. Do not edit: run `bun run generate`. -->
